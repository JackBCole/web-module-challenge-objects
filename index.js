...
console.log(createMenuItem("club sandwich", 22, "Dinner"))
...
console.log(addRating(reviews, "Jack", 0.1, "food tastes like hot garbage!"))
...
function reynasFeedback(arr, index, feedback){
    arr[index].feedback = feedback;
    return arr;
}

console.log(reynasFeedback(reviews, 7, "this place is chill with really cool people, great for getting work done on weekdays"));
...
and should return an array of objects. 
  ...
  For example, invoking getLongReviews(reviews) would return [
    ...
    {name: "Julius", rating: 2, feedback: "I was largely unimpressed by this venue. Nothing special on the menu and too expensive. The atmosphere is polarizing, and not for me, but I think some would like it." }]
*/
  function getLongReviews(arr, index) {
    let longWindedOnes = [];
    
    for(i = 0; i < arr.length; i++){
      if(arr[index].feedback.splice(' ') > 15){
        longWindedOnes.push(arr[index].feedback);
      }
    }
    return longWindedOnes
  }
